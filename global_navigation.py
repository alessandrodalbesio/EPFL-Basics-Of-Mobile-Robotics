...
def find_visible_lines(obstacles,initialPoint,finalPoint):
    ...
    obstacles_pts = np.concatenate(obstacles)
...
def plot_visibility(lines, obstacles, initialPoint, finalPoint):
    ...
    plt.plot(initialPoint[0],initialPoint[1], marker='X',ms=10,color = 'red')
    plt.plot(finalPoint[0],finalPoint[1], marker='X',ms=10,color = 'red')
...
def create_weight_matrix(initialPoint, finalPoint, obstacles):

    lines , all_points = find_visible_lines(obstacles,initialPoint,finalPoint)
...
def find_optimal_path(initialPoint, finalPoint, obstacles):

    nb_pts, all_points, weight_matrix = create_weight_matrix(initialPoint, finalPoint, obstacles)
